...
const FEATURES = [
  {
    ...
    desc: "Process thousands of rows from Excel into pristine PDFs in seconds.",
    color: "#00e599",
    bg: "rgba(0,229,153,0.08)",
  },
  {
    icon: ShieldCheck,
    title: "Unique Cert IDs",
    desc: "Unforgeable CERT-XXXX identifiers in every document and QR code.",
    color: "#9d4edd",
  ...
  },
  {
    ...
    desc: "Anyone can scan to view a public authenticity page instantly.",
    color: "#007acc",
  ...
  },
  {
    ...
    desc: "All assets stored in AWS S3, metadata in Neon Postgres.",
    color: "#e0aaff",
    bg: "rgba(224,170,255,0.08)",
  },
  {
    icon: Key,
    title: "API Access",
    desc: "Generate certificates from any system using your secret API key.",
    color: "#f59e0b",
  ...
  },
  {
    ...
    desc: "Track every API call — endpoint, status, cert ID, timestamp.",
    color: "#f87171",
...
const REVIEWS = [
  {
    ...
    rating: 5,
    text: "Vura saved us countless hours during our last hackathon. Generating 500+ certificates took literally 2 seconds instead of a whole weekend. Incredibly reliable.",
  },
  {
    name: "Swayam Polakhare",
    role: "Tech Lead",
    rating: 4.5,
    text: "The API integration is flawless. We plugged Vura directly into our internal LMS, and now every student receives a verifiable PDF the moment they finish a course.",
  },
  {
    name: "Swaraj Singh",
    role: "Operations Head",
    rating: 4,
    text: "The QR verification system gives so much credibility to our workshops. Participants love being able to instantly prove their credentials online.",
  },
  {
    name: "Mayank Tiwari",
    role: "University Administrator",
    rating: 5,
    text: "What used to be a massive logistical headache at the end of every semester is completely automated now. The visual template mapper is a lifesaver.",
  },
  {
    name: "Sujal Dubey",
    role: "Community Manager",
    rating: 4.5,
    text: "Best certificate generator out there. Extremely fast, the Next.js performance is snappy, and the generated PDFs look incredibly professional.",
  },
  {
    name: "Karan Sathe",
    role: "Startup Founder",
    rating: 5,
    text: "We needed a robust way to issue early-adopter certificates. Vura's AWS-backed storage and unique IDs gave us exactly the security and scale we required.",
  },
];
...
const STEPS = [
  {
    ...
    desc: "Sign up and secure your API keys to get started with Vura.",
  },
  {
    n: "02",
    icon: FileText,
    title: "Upload Template",
    desc: "Drop your blank PDF design. Use the visual mapper to pin name, course, date, and QR fields.",
  },
  {
    n: "03",
    icon: FileSpreadsheet,
    title: "Map Your Data",
    desc: "Upload an Excel file with Name, Course, IssueDate columns — or POST via API with JSON.",
  },
  {
    n: "04",
    icon: Sparkles,
    title: "Generate & Share",
    desc: "Click Generate. Vura builds, uploads to S3, and returns direct PDF + verify links instantly.",
  },
];
    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="relative w-full overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 px-6 pt-16 pb-20 lg:pt-20 lg:pb-32 max-w-7xl mx-auto w-full">
            <motion.div
              ...
              animate="visible"
              variants={stagger}
              className="relative z-10 flex flex-col max-w-xl w-full"
            >
              <motion.h1
                variants={fadeUp}
                className="text-[3.5rem] lg:text-[5rem] font-medium tracking-tight leading-[1] text-white"
              >
                Automated
                <br />
                Certificate
              ...
              <motion.p
                variants={fadeUp}
                className="mt-8 text-xl text-white/80 leading-[1.6]"
              >
                We empower organizations with seamless automation and secure,
                verifiable credentials to issue bulk certificates faster.
              </motion.p>
              ...
              <motion.p
                variants={fadeUp}
                className="mt-8 text-sm text-[var(--color-neon-muted)] flex items-center gap-2"
              >
                <span className="w-2 h-2 rounded-full bg-[var(--color-neon-primary)] animate-pulse shadow-[0_0_8px_#00e599]" />
                Trusted by 50+ educators and event organizers · No credit card
                required
              </motion.p>
            </motion.div>
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                ...
                <span className="text-sm font-medium tracking-tight text-[var(--color-neon-muted)]">
                  {s.label}
                </span>
              </motion.div>
            ))}
        ...
        <section
          id="how-it-works"
          ref={howItWorksRef}
          className="py-28 px-6 bg-[rgba(6,6,6,0.6)] z-10 relative"
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative mx-auto mt-20 max-w-5xl">
              ...
              <div className="hidden md:block absolute top-[17px] left-[12.5%] right-[12.5%] h-[2px] bg-[#222] z-0">
                <div
                  className="h-full bg-[var(--color-neon-primary)] transition-all duration-500 shadow-[0_0_8px_rgba(0,229,153,0.4)]"
                  style={{
                    ...
                    >
                      ...
                      {!isLast && (
                        <div className="md:hidden absolute left-[17px] top-[36px] bottom-[-48px] w-[2px] bg-[#222] z-0">
                          <div
                            className={`w-full h-full transition-colors duration-500 ${isCompleted ? "bg-[var(--color-neon-primary)]" : "bg-transparent"}`}
                          />
                        </div>
                      )}
                        ...
                        <div className="w-[28px] h-[28px] rounded-full flex items-center justify-center relative bg-[#070707]">
                          ...
                          {isActive && (
                            <motion.div
                              ...
                              className="absolute inset-[-8px] rounded-full bg-[var(--color-neon-primary)]/20 shadow-[0_0_20px_rgba(0,229,153,0.3)] pointer-events-none"
                            />
                          )}
                      ...
                      {/* Step Content */}
                      <div
                        className={`flex flex-col items-start md:items-center transition-all duration-300 w-full pt-4 ${isActive ? "opacity-100" : "opacity-40 group-hover:opacity-70"}`}
                      >
        ...
        <section
          id="features"
          className="py-28 px-6 relative overflow-hidden bg-[rgba(3,3,3,0.8)]"
        >
          ...
          <div className="absolute inset-0 pointer-events-none z-0">
            {[
              ...
              <div
                key={i}
                className="absolute w-[1.5px] h-[1.5px] bg-white rounded-full animate-pulse shadow-[0_0_8px_rgba(255,255,255,0.8)] opacity-60"
                style={{
                  top: s.top,
                  left: s.left,
          ...
          <div className="max-w-[1400px] mx-auto relative z-10">
            ...
            >
              <span className="section-label inline-flex !bg-[rgba(0,229,153,0.15)] !border-[rgba(0,229,153,0.4)] !text-[#00e599] backdrop-blur-md shadow-[0_0_20px_rgba(0,229,153,0.1)]">
                Features
              </span>
              <h2 className="mt-5 text-4xl md:text-5xl font-medium tracking-tight text-white drop-shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
                Everything you need,
                <br />
                nothing you don&apos;t
              </h2>
            ...
            <div className="hidden md:grid md:grid-cols-3 xl:flex xl:flex-nowrap xl:justify-between gap-5 pb-10 pt-4 w-full">
              {FEATURES.map((f, i) => (
                ...
                >
                  ...
                  <div
                    className="relative z-10 transition-transform duration-300 group-hover:scale-110 mb-5 text-[var(--color-neon-primary)]"
                    style={{ color: f.color }}
                  >
                  ...
                  <h3
                    className="text-[17px] md:text-lg font-medium tracking-tight mb-3 relative z-10 leading-tight px-2 transition-colors duration-300"
                    style={{ color: f.color }}
                  >
                    {f.title}
                  </h3>
                  ...
                  <p
                    className="text-[14px] leading-relaxed relative z-10 opacity-90 transition-colors duration-300 max-w-[200px]"
                    style={{ color: f.color }}
                  >
                    {f.desc}
                  </p>
            ...
            <div
              className="md:hidden relative flex overflow-hidden w-full py-4 -mx-6 px-6"
              style={{
                WebkitMaskImage:
              ...
              <div className="flex shrink-0 gap-4 w-max animate-marquee pb-4">
                {[...FEATURES, ...FEATURES].map((f, i) => (
                  ...
                  >
                    ...
                    <h3
                      className="text-[17px] font-medium tracking-tight mb-3 relative z-10 leading-tight px-2 transition-colors duration-300"
                      style={{ color: f.color }}
                    >
                      {f.title}
                    </h3>
        ...
        <div className="px-4 py-12 md:px-8 w-full max-w-[1400px] mx-auto">
          <section
            id="reviews"
            className="py-24 px-6 border border-[var(--color-neon-border)] bg-[#030604] relative overflow-hidden rounded-[2.5rem] md:rounded-[3.5rem] shadow-[0_0_80px_rgba(3,6,4,0.8)]"
          >
            <div className="max-w-6xl mx-auto relative z-10">
              ...
              <div
                className="relative flex overflow-hidden w-full max-w-7xl mx-auto py-8 lg:-mx-12 px-6 lg:px-12"
                style={{
                  WebkitMaskImage:
                    "linear-gradient(to right, transparent, black 10%, black 90%, transparent)",
                  maskImage:
                  ...
                  {[...REVIEWS, ...REVIEWS].map((r, i) => (
                    ...
                    >
                      <div className="flex items-center gap-1">
                        {[1, 2, 3, 4, 5].map((star) => {
                          ...
                          if (r.rating >= star) {
                            ...
                            return (
                              <div
                                key={star}
                                className="relative w-5 h-5 text-[#00e599]"
                              >
                                <svg
                                  className="absolute inset-0 w-5 h-5 opacity-30"
                                  fill="currentColor"
                                  viewBox="0 0 20 20"
                                >
                                  <path d={pathD} />
                          ...
                          return (
                            <svg
                              key={star}
                              className="w-5 h-5 text-[#00e599] opacity-30"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path d={pathD} />
                        ...
                        <span className="text-[var(--color-neon-primary)] text-sm font-bold ml-1.5">
                          {r.rating.toFixed(1)}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center gap-4 pt-6 border-t border-[var(--color-neon-border)]/50">
                        ...
                        <div>
                          ...
                          <p className="text-[12px] text-[var(--color-neon-muted)] mt-0.5">
                            {r.role}
                          </p>
                        </div>
                      </div>
        ...
        <div className="px-4 py-12 md:px-8 w-full max-w-[1400px] mx-auto">
          <section className="py-24 px-6 relative overflow-hidden bg-[#030604] rounded-[2.5rem] md:rounded-[3.5rem] border border-[var(--color-neon-border)] shadow-2xl">
            ...
            >
              ...
              <p className="text-[var(--color-neon-muted)] mb-10 text-lg md:text-xl max-w-xl mx-auto">
